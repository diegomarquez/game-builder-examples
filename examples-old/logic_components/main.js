...
//These are reusable modules that can be attached to different kinds of game-objects. 
...
//It will make the associated game-object twitch like crazy, according to
//a number we pass in when configuring it.

gjs.setModulePath('logic-bundle');
