module.exports = function(grunt) {
  var files = [
    ...
    'examples/fixed_state-machine/Gruntfile.js',
    'examples/game-object_creation/Gruntfile.js',
    'examples/game-object_nesting/Gruntfile.js',
    'examples/keyboard/Gruntfile.js',
    'examples/layering/Gruntfile.js',
    'examples/logic_components/Gruntfile.js',
    'examples/loose_state-machine/Gruntfile.js',
